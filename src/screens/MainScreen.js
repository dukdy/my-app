...
export default function MainScreen({ }) {
  ...
  //       { id: '31', name: 'Chuôi SportII ICE AMP', price: '8.000.000đ', image: require('../assets/pre ICE AMP.png') },
  //       { id: '32', name: 'Chuôi SportII Volt Wrap', price: '9.000.000đ', image: require('../assets/pre volt wrap.png') },
  //       { id: '33', name: 'Ngọn REVO 12.9 3/8-10 Black ', price: '15.540.000đ', image: require('../assets/ngon pre 12.9.png') },
  //       { id: '34', name: 'Ngọn REVO 11.8 Uni-loc White ', price: '15.540.000đ', image: require('../assets/ngon pre 11.8.png') }
  //     ]
  //   },
  //   {
